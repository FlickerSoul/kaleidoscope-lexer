...
@attached(peer)
public macro token<T: LexerProtocol, R: Into<TokenResult<T>>>(
    _ value: String,
    priority: UInt? = nil,
...
/// Token regex definition macro, with a callback
@attached(peer)
public macro regex<T: LexerProtocol, R: Into<TokenResult<T>>>(
    _ value: String,
    priority: UInt? = nil,
    createCallback: @escaping CreateCallback<T, R>,
) = #externalMacro(module: "KaleidoscopeMacros", type: "EnumCaseRegistry")
...
@attached(peer)
public macro regex(_ value: String, priority: UInt? = nil) = #externalMacro(
    module: "KaleidoscopeMacros",
    type: "EnumCaseRegistry",
)
...
public macro kaleidoscope(skip chars: String? = nil) = #externalMacro(
    module: "KaleidoscopeMacros",
