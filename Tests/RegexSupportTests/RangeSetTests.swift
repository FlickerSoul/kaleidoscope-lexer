...
struct RangeSetTests {
    ...
    func `invert empty set gives full range`() {
        ...
        rangeSet.invert()
        #expect(rangeSet.ranges == [Character.minValue ... Character.maxValue])
    }

    @Test
    func `invert full range gives empty set`() {
        var rangeSet = RangeSet<Character>(ranges: [Character.minValue ... Character.maxValue])
        rangeSet.invert()
    ...
    func `invert middle range gives two ranges`() {
        ...
        rangeSet.invert()
        #expect(rangeSet.ranges.count == 2)
        #expect(rangeSet.ranges[0].lowerBound == Character.minValue)
        #expect(rangeSet.ranges[0].upperBound == "l")
        #expect(rangeSet.ranges[1].lowerBound == "q")
        #expect(rangeSet.ranges[1].upperBound == Character.maxValue)
    }
